...
internal fun updateAppWidget(
    ...
    var sharedPreferenceName = "com.example.appwidgets"
    var COUNT_KEY = "count"
    ...
    var mSharedPreferences = context.getSharedPreferences(sharedPreferenceName,0)
    var count = mSharedPreferences.getInt(COUNT_KEY + appWidgetId,0)
    count++

    val dateString = DateFormat.getTimeInstance(DateFormat.SHORT).format(Date())

    views.setTextViewText(R.id.appwidget_update,context.resources.getString(R.string.date_count_formate,count,dateString))

    val preEditor = mSharedPreferences.edit()
